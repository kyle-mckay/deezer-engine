...
from tests.input_output_offline_support import EXPECTED_COUNTS, TOTAL_COUNT_KEYS, preserve_runtime_state, run_input_output_once


pytestmark = [pytest.mark.integration, pytest.mark.offline, pytest.mark.slow]

MODULE_CACHE_KEY = "offline-totals"
